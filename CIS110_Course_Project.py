...
gender = input("What is your dog's gender?  Please enter m or f  ")
...
sex = input("What is your gender?  Please enter m or f  ")
...
sex = input
if sex == "m":
   print(dogName, "was left by" ,userName, "at the local shelter for the weekend while he went away.")
else:
    print(dogName, "was left by" ,userName, "at the local shelter for the weekend while she went away.")


gender = input
if gender == "m":
   print(dogName, "liked going for morning runs with his owner." ,dogName, "really wanted to go for a run, he saw that the gate was accidently left open!")

else:
    print(dogName, "liked going for morning runs with her owner." ,dogName, "really wanted to go for a run, she saw that the gate was accidently left open!")
...
if sneakIntoPond == "yes":
    ...
    print("When the homeowners find" ,dogName, "jumping and playing in the" ,pond, "pond they yell very loud at him while they try getting him out." ,dogName, "gets very scared and runs between the homeowners and into their prized rose garden, trampling their award winning roses!")
    ...
    print("Being too afraid of getting caught, the dog sees a sprinkler at a nearby house and lays in the puddle on the sidewalk for " ,number, "minutes before the sprinkler automatically turns off, forcing him to leave.")

print("\nAfter a hot long day exploring " ,town,"," ,dogName,  "comes across a family cookout in the park.")
print(dogName, "had played and cooled off in the" ,pond, "pond,  and now he was very hungry!")
...
if checkOutCookout == "yes":
    ...
    print(dogName, "spends",number, "minutes eating the bbq food and playing with all the children before laying down for a quick nap before heading off.  Surprsingly, nobody realized that" ,dogName, "didn't belong to anyone at the cookout")
else:
    print("\nHe decides not to go into the family cookout." ,breed, " get scared very easily.")
    print("\nBeing too afraid of all the new people and worried that someone might call the police,")
    print(dogName, "decides to just keep on walking hoping that no one notices him, he does not want to make a scene.")
...
if sneakIntoPond == "yes" and checkOutCookout == "yes":
    ...
    print("Luckily, the police noticed " ,userName, "was printed on the dogs collar, and he was returned to the kennel successfully.")
